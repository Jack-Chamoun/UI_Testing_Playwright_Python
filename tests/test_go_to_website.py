...
class Test_go_to_website:
    def test_go_to_website(self, page):
        ...
        expect(page.get_by_role("alert")).to_contain_text("Warnings! This is a demo website for web scraping purposes. Prices and ratings here were randomly assigned and have no real meaning.")
